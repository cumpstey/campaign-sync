...
{
    [TestFixture(TestOf = typeof(JsspMetadataProcessor))]
    public class JsspMetadataProcessorTests : TestBase
    {
        ...
        public void Extract()
        {
            ...
            var metadataProcessor = new JsspMetadataProcessor(new DummyMetadataParser(), new DummyMetadataFormatter());

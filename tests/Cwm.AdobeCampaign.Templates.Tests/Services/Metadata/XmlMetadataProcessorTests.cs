...
{
    [TestFixture(TestOf = typeof(XmlMetadataProcessor))]
    public class XmlMetadataProcessorTests : TestBase
    {
        ...
        public void Extract()
        {
            ...
            var metadataProcessor = new XmlMetadataProcessor(new DummyMetadataParser(), new DummyMetadataFormatter());
        ...
        [Test(Description = "Invalid xml.")]
        public void InvalidXml()
        {
            var input = GetEmbeddedResource("InvalidXml_Input");

...
{
    [TestFixture(TestOf = typeof(PlainTextMetadataProcessor))]
    public class PlainTextMetadataProcessorTests : TestBase
    {
        ...
        public void Extract()
        {
            ...
            var metadataProcessor = new PlainTextMetadataProcessor(new DummyMetadataParser(), new DummyMetadataFormatter());
